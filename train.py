...
def main():
    ...
    parser.add_argument('--loss_fn', default='triplet',
                        help='Loss function used (triplet | CCL or ConVSE | CCLHN or ConVSE++)')
    parser.add_argument('--temp', default=0.1, type=float,
                        help='Temperature value used for scaling while computing loss')
